...
const Logos = () => {
  return (
    <div className={styles.logos}>
      <div className={styles.container_logos_left}>
        <div className={styles.container_logos_left_first_part}>
          <figure>
        ...
        <div className={styles.container_logos_left_second_part}>
          <figure>
      ...
      <div className={styles.container_logos_right}>
        <figure>
